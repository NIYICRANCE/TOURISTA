	...
	<div class="row">
		<div class="col-sm-6 col-xs-7" style="min-height: 500px">
	      ...
	      <?php print '<td>';
	        ...
	        print '<a href= "'.base_url().'admin/ctg_delete/'.$ctg_detail->id.'" title= "Delete" class="btn btn-danger btn-sm delete" data-confirm = "Are you sure to delete this category? If it deleted user can not find the publication from this category."> <i class= "fas fa-trash"></i> Delete</a>&nbsp';
